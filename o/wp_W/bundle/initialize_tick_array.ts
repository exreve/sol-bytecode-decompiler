...
// instruction initialize_tick_array: handler + 18 reachable functions
...
function ix_initialize_tick_array(a: u64, program_id: u64, accounts: u64, accounts_len: u64, ix_args: u64, ix_args_len: u64): u64 {
...
function accounts_initialize_tick_array(a: u64, b: u64, c: u64, d: u64, e: u64): u64 {
...
function fn_32f48(a: u64, b: InitializeTickArrayContext, c: u64, d: u64, e: u64, r0: u64): u64 {
...
function fn_aef00(a: u64, b: u64, c: u64): u64 {
...
// account checks: account (errors raised when a check on it fails) [str: account-error names, Anchor error codes]: tick_array
function fn_ad230(a: u64, b: u64, c: u64, d: u64, e: u64): u64 {
