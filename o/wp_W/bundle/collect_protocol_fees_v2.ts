...
// instruction collect_protocol_fees_v2: handler + 48 reachable functions
...
function ix_collect_protocol_fees_v2(a: u64, program_id: u64, accounts: u64, accounts_len: u64, ix_args: u64, ix_args_len: u64): u64 {
...
function accounts_collect_protocol_fees_v2(a: u64, b: u64, c: u64, d: u64, e: u64): u64 {
...
function fn_3b6d8(a: u64, b: CollectProtocolFeesV2Context, c: u64, r9: u64): u64 {
...
function fn_d7470(a: u64, b: u64, c: u64): u64 {
...
function fn_1253c0(a: u64, b: u64, c: u64, r0: u64): u64 {
...
function fn_124e20(a: u64, b: u64) {
	const s18 = fp - 0x18, s30 = fp - 0x30
	let f = ld64(a)
	let g = f + 1
	let l = 0
