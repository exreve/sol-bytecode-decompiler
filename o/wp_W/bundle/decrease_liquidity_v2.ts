...
// instruction decrease_liquidity_v2: handler + 14 reachable functions
...
function ix_decrease_liquidity_v2(a: u64, b: u64, accounts: u64, accounts_len: u64, ix_args: u64, ix_args_len: u64): u64 {
	const s4c0 = fp - 0x4c0, s4d0 = fp - 0x4d0, s4e0 = fp - 0x4e0
	let j, k: u64
	sol_log("Instruction: DecreaseLiquidityV2", 0x20)
	...
	fn_1494c8("internal error: entered unreachable code", 0x28, 0x10015a958)
}
