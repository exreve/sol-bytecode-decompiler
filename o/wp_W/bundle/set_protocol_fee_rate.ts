...
// instruction set_protocol_fee_rate: handler + 4 reachable functions
...
// instruction handler: set_protocol_fee_rate (discriminator sha256("global:set_protocol_fee_rate")[..8] = 0x839c4f9a3204075f)
...
function ix_set_protocol_fee_rate(a: u64, program_id: u64, accounts: u64, accounts_len: u64, ix_args: u64, ix_args_len: u64): u64 {
	const s2f0 = fp - 0x2f0, s308 = fp - 0x308, s316 = fp - 0x316, s5a0 = fp - 0x5a0, s5f8 = fp - 0x5f8, s610 = fp - 0x610, s620 = fp - 0x620, s630 = fp - 0x630, s640 = fp - 0x640, s650 = fp - 0x650, s660 = fp - 0x660
	let h, k: u64
	sol_log("Instruction: SetProtocolFeeRate", 0x1f)
	if (2 > ix_args_len) {
