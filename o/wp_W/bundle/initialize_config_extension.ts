...
// instruction initialize_config_extension: handler + 17 reachable functions
...
function ix_initialize_config_extension(a: u64, program_id: u64, accounts: u64, accounts_len: u64): u64 {
...
function accounts_initialize_config_extension(a: u64, b: u64, c: u64, d: u64, e: u64): u64 {
...
// account checks: account (errors raised when a check on it fails) [str: account-error names, Anchor error codes]: config_extension
function fn_ebed0(a: u64, b: u64, c: u64, d: u64, e: u64): u64 {
...
function fn_102d80(a: u64, b: u64, c: u64, d: u64, e: u64) {
	const s20 = fp - 0x20
	let r: u64
	const f = ld64(b + 8)
	if (7 >= f) {
