...
// instruction increase_liquidity: handler + 54 reachable functions
...
function ix_increase_liquidity(a: u64, program_id: u64, accounts: u64, accounts_len: u64, ix_args: u64, ix_args_len: u64): u64 {
...
function accounts_increase_liquidity(a: u64, b: u64, c: u64, d: u64, e: u64, r0: u64): u64 {
...
function fn_11dc98(a: u64, b: IncreaseLiquidityContext, c: u64, d: u64, e: u64): u64 {
...
function fn_ab558(a: u64, b: u64, c: u64): u64 {
...
function fn_2a150(a: u64, b: IncreaseLiquidityContext, c: u64, d: u64, p5: u64, p6: u64, p7: u64): u64 {
...
function fn_71878(a: u64, b: u64, c: u64, d: u64, e: u64): u64 {
...
function fn_110060(a: u64, b: u64) {
	const f = ld64(0x300000000 /* heap bump-allocator cursor */)
	const g = f != 0 ? sat_sub(f, 0x100) : 0x300007f00
	if (0x300000007 >= g) {
