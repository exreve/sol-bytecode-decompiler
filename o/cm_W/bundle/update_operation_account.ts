...
// instruction update_operation_account: handler + 41 reachable functions
...
function ix_update_operation_account(a: u64, program_id: u64, accounts: u64, accounts_len: u64, ix_args: u64, ix_args_len: u64): u64 {
...
function accounts_update_operation_account(a: u64, b: u64, c: u64, d: u64, e: u64, r0: u64): u64 {
...
function fn_4f4c8(a: u64, b: u64, c: u64, d: u64, e: u64): u64 {
...
function fn_68450(a: u64, b: u64): u64 {
...
// instruction data may reach [heur: flow-insensitive taint from the handlers' ix_args]: b (points to it), a (value)
function fn_69378(a: u64, b: u64): u64 {
...
// instruction data may reach [heur: flow-insensitive taint from the handlers' ix_args]: b (points to it), a (value)
function fn_67dd8(a: u64, b: u64, c: u64, d: u64, e: u64): u64 {
...
// instruction data may reach [heur: flow-insensitive taint from the handlers' ix_args]: b (points to it), a (value)
function fn_68d08(a: u64, b: u64): u64 {
...
function fn_1d0(a: u64, b: u64, c: u64, r0: u64): u64 {
...
// instruction data may reach [heur: flow-insensitive taint from the handlers' ix_args]: b (value)
function fn_19630(a: u64, b: u64, c: u64): u64 {
...
function fn_112c8(a: u64, b: u64, c: u64, d: u64, e: u64) {
...
function fn_14d500(a: u64, b: u64, c: u64, d: u64, e: u64) {
	const s30 = fp - 0x30
	if (b != 0) {
...
function fn_129d0(a: u64, b: u64, c: u64, d: u64, p5: u64, p6: u64) {
...
function fn_10d18(a: u64, b: u64, c: u64, d: u64): u64 {
	let h = c
	let i = b
	let f = a
	if (d >= 8) {
...
function fn_1530f0(a: u64, b: u64, c: u64, d: u64, e: u64): never {
	const s30 = fp - 0x30
