...
// instruction create_amm_config: handler + 38 reachable functions
...
function ix_create_amm_config(a: u64, program_id: u64, accounts: u64, accounts_len: u64, ix_args: u64, ix_args_len: u64): u64 {
...
function accounts_create_amm_config(a: u64, b: u64, c: u64, d: u64, e: u64, r0: u64): u64 {
...
function fn_4b0e0(a: u64, b: CreateAmmConfigContext, c: u64, d: u64, e: u64): u64 {
...
function fn_c4d20(a: u64, b: u64, c: u64): u64 {
	const s10 = fp - 0x10
...
function fn_c3400(a: u64, b: u64, c: u64, d: u64, e: u64): u64 {
...
function fn_86f8(a: u64, b: AccountInfo): u64 {
...
function fn_10b930(a: u64, b: u64, c: u64, d: u64, e: u64): u64 {
...
function fn_16bb8(a: u64, b: u64, r0: u64): u64 {
	const g = ld64(b)
	const f = ld64(b + 8)
	let h = f
	let l = g
