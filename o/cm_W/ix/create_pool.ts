...
import { anchor_error_from, fn_10fb10, fn_13e5a0, fn_13e628, fn_1476d8, fn_147a20, fn_14ed60, fn_4130, fn_4688, fn_6490, fn_65410, fn_66e8, fn_6940, fn_697e0, fn_6a7e8, fn_7e058, fn_7e560, fn_81db0, fn_85138, fn_88558, fn_f6fe8, log_data, memcpy, memset2 } from '../shared.ts'
...
export function ix_create_pool(a: u64, program_id: u64, accounts: u64, accounts_len: u64, ix_args: u64, ix_args_len: u64): u64 {
...
export function accounts_create_pool(a: u64, b: u64, c: u64, d: u64, e: u64, r0: u64): u64 {
...
export function fn_8c030(a: u64, b: u64, c: u64, d: u64, e: u64): u64 {
...
export function fn_8dc68(a: u64, b: u64, c: u64, d: u64, e: u64): u64 {
...
export function fn_8f680(a: u64, b: u64, c: u64, d: u64, e: u64): u64 {
	const s1 = fp - 0x1, s28 = fp - 0x28, s48 = fp - 0x48, s49 = fp - 0x49, s70 = fp - 0x70, s71 = fp - 0x71, s98 = fp - 0x98, sa8 = fp - 0xa8, s108 = fp - 0x108, s110 = fp - 0x110, s130 = fp - 0x130, s150 = fp - 0x150, s168 = fp - 0x168, s180 = fp - 0x180, s188 = fp - 0x188, s1a8 = fp - 0x1a8, s1e0 = fp - 0x1e0, s1f0 = fp - 0x1f0, s210 = fp - 0x210, s218 = fp - 0x218, s21f = fp - 0x21f, s228 = fp - 0x228, s240 = fp - 0x240, s248 = fp - 0x248, s260 = fp - 0x260, s270 = fp - 0x270, s280 = fp - 0x280, s290 = fp - 0x290, s2a0 = fp - 0x2a0, s2b0 = fp - 0x2b0, s2c0 = fp - 0x2c0, s308 = fp - 0x308, s310 = fp - 0x310, s318 = fp - 0x318, s320 = fp - 0x320, s328 = fp - 0x328, s330 = fp - 0x330, s338 = fp - 0x338, s340 = fp - 0x340, s348 = fp - 0x348, s350 = fp - 0x350, s358 = fp - 0x358, s360 = fp - 0x360, s368 = fp - 0x368
	let af, cn, cq, cr: u64
	const f: AccountInfo = ld64(ld64(b))
	const g = fn_147a20(f, b, c, d, e)
...
export function fn_1a610(a: u64, b: CreatePoolContext, c: u64, d: u64, e: u64, r0: u64): u64 {
