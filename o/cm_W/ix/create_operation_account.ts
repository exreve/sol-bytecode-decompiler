...
// instruction create_operation_account
import { anchor_error_from, fn_13e5a0, fn_13e628, fn_1476d8, fn_147a20, fn_14ed60, fn_153158, fn_4130, fn_4688, fn_88360, fn_ccf98, memset2 } from '../shared.ts'
...
export function ix_create_operation_account(a: u64, program_id: u64, accounts: u64, accounts_len: u64): u64 {
...
export function accounts_create_operation_account(a: u64, b: u64, c: u64, d: u64, e: u64, r0: u64): u64 {
...
export function fn_cb6f8(a: u64, b: u64, c: u64, d: u64, e: u64): u64 {
...
export function fn_4f238(a: u64, b: CreateOperationAccountContext, c: u64, d: u64, e: u64): u64 {
