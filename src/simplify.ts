...
import {
  ...
  evalBin, evalCmp, evalExt, evalBswap, Trap, walkExpr, hasSideEffectsOrMem, exprEq, u64, exprSize, INTRINSICS, type Intrinsic, isMemIntrinsic, isDivOp, safeDivisor,
} from './ir.ts';
